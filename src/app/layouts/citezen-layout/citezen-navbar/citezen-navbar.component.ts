...
@Component({
  selector: 'citezen-navbar',
  templateUrl: './citezen-navbar.component.html',
  styleUrls: ['./citezen-navbar.component.scss']
})
export class CitezenNavbarComponent implements OnInit{
  ...
  private listTitles: any[];
    ...
    constructor(location:Location, private renderer : Renderer2, private element : ElementRef, private router: Router, private securityService: SecurityService) {
