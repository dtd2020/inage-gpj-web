export class AlertNextStepEnum {
    ...
    static readonly FOLLOW_UP_ALLOCATION = new AlertNextStepEnum('FOLLOW_UP_ALLOCATION', 'Dar seguimento do processo', 'back-office/allocations/follow-up', 'citezen/allocations/follow-up');
